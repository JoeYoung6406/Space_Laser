...
class EnemyShip extends Ship {
    ...
    public EnemyShip(float xCentre, float yCentre,
        ...
        super(xCentre, yCentre, enemy_width, enemy_height, movementSpeed, shield, laserWidth, laserHeight, laserMovementSpeed, timeBetweenShots, shipTextureRegion, shieldTextureRegion, laserTextureRegion);
